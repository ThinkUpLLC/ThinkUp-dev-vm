...
$THINKUP_CFG['site_root_path']            = '/mythinkup/';
...
$THINKUP_CFG['datadir_path']              = $THINKUP_CFG['source_root_path'] . 'webapp/data/web/';

// Your timezone
$THINKUP_CFG['timezone']                  = 'America/New_York';
...
$THINKUP_CFG['db_password']               = 'nice2bnice';
$THINKUP_CFG['db_name']                   = 'thinkup_web';
...
//    $THINKUP_CFG['source_root_path']          = '/your-server-path-to/thinkup/';
    $THINKUP_CFG['db_user']                   = 'root'; //Use root here for CREATE DATABASE perms
    $THINKUP_CFG['db_password']               = 'nice2bnice';
    $THINKUP_CFG['datadir_path']              = $THINKUP_CFG['source_root_path'] . 'webapp/data/tests/';
    $THINKUP_CFG['log_location']              = $THINKUP_CFG['datadir_path'] . '/logs/crawler.log';
    $THINKUP_CFG['stream_log_location']       = $THINKUP_CFG['datadir_path'] . '/logs/stream.log';
    $THINKUP_CFG['db_name']                   = 'thinkup_tests'; //by default, thinkup_tests
    $THINKUP_CFG['invalid_db_host']           = 'localcheese';
    $THINKUP_CFG['timezone']                  = 'UTC';
    $THINKUP_CFG['set_pdo_charset']           = false;
    //Should be strict in dev mode; alas
